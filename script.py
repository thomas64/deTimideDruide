...
class Script:
    ...
    def load_game(data):
        ...
        """
        timestamp = datetime.datetime.now()
        if datetime.datetime(2017, 5, 14, 6, 00) < timestamp < datetime.datetime(2017, 5, 16, 11, 00):
            data.map_name = 'kruising'
            data.map_pos = 'start_game'
            data.map_dir = Direction.South
        elif datetime.datetime(2017, 5, 16, 11, 00) < timestamp < datetime.datetime(2017, 5, 16, 15, 00):
            data.map_name = 'kruising2'
            data.map_pos = 'start_game'
            data.map_dir = Direction.West
