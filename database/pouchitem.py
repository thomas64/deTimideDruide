...
class PouchItemDatabase(enum.Enum):
    ...
    water_waal = dict(nam="Water Waal",             srt=28, spr=WATERRIVIER,        desc="", val=3)
    water_maas = dict(nam="Water Maas",             srt=28, spr=WATERRIVIER,        desc="", val=3)
    water_niers = dict(nam="Water Niers",           srt=28, spr=WATERRIVIER,        desc="", val=3)
    bloem_geel = dict(nam="Gele bloem",             srt=29, spr=BLOEMGEEL,          desc="", val=3)
    bloem_blauw = dict(nam="Blauwe bloem",          srt=29, spr=BLOEMBLAUW,         desc="", val=3)
    bloem_rood = dict(nam="Rode bloem",             srt=29, spr=BLOEMROOD,          desc="", val=3)
